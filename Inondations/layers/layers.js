...
cluster_VueinterventionsInondationsBrunehaut_1 = new ol.source.Cluster({
  distance: 30,
...
var lyr_VueinterventionsInondationsBrunehaut_1 = new ol.layer.Vector({
                declutter: false,
                source:cluster_VueinterventionsInondationsBrunehaut_1, 
...
var format_Inondations30052026_2 = new ol.format.GeoJSON();
var features_Inondations30052026_2 = format_Inondations30052026_2.readFeatures(json_Inondations30052026_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Inondations30052026_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Inondations30052026_2.addFeatures(features_Inondations30052026_2);
cluster_Inondations30052026_2 = new ol.source.Cluster({
  distance: 30,
  source: jsonSource_Inondations30052026_2
});
var lyr_Inondations30052026_2 = new ol.layer.Vector({
                declutter: false,
                source:cluster_Inondations30052026_2, 
                style: style_Inondations30052026_2,
                popuplayertitle: 'Inondations 30-05-2026',
                interactive: true,
                title: 'Inondations 30-05-2026'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_VueinterventionsInondationsBrunehaut_1.setVisible(true);lyr_Inondations30052026_2.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_VueinterventionsInondationsBrunehaut_1,lyr_Inondations30052026_2];
...
lyr_Inondations30052026_2.set('fieldAliases', {'fid': 'fid', 'Type d\'intervention': 'Type d\'intervention', 'Numéro Verdi': 'Numéro Verdi', 'Etat d\'intervention': 'Etat d\'intervention', 'Rue': 'Rue', 'Numéro': 'Numéro', 'Code Postal': 'Code Postal', 'Commune': 'Commune', 'Date d\'intervention': 'Date d\'intervention', 'Heure': 'Heure', 'Jour': 'Jour', 'Mois': 'Mois', 'Annee': 'Annee', 'Latitude': 'Latitude', 'Longitude': 'Longitude', });
...
lyr_Inondations30052026_2.set('fieldImages', {'fid': 'TextEdit', 'Type d\'intervention': 'TextEdit', 'Numéro Verdi': 'TextEdit', 'Etat d\'intervention': 'TextEdit', 'Rue': 'TextEdit', 'Numéro': 'TextEdit', 'Code Postal': 'TextEdit', 'Commune': 'TextEdit', 'Date d\'intervention': 'TextEdit', 'Heure': 'TextEdit', 'Jour': 'Range', 'Mois': 'Range', 'Annee': 'Range', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', });
...
lyr_Inondations30052026_2.set('fieldLabels', {'fid': 'hidden field', 'Type d\'intervention': 'inline label - always visible', 'Numéro Verdi': 'hidden field', 'Etat d\'intervention': 'inline label - always visible', 'Rue': 'inline label - always visible', 'Numéro': 'inline label - visible with data', 'Code Postal': 'inline label - always visible', 'Commune': 'inline label - always visible', 'Date d\'intervention': 'inline label - always visible', 'Heure': 'hidden field', 'Jour': 'hidden field', 'Mois': 'hidden field', 'Annee': 'hidden field', 'Latitude': 'hidden field', 'Longitude': 'hidden field', });
lyr_Inondations30052026_2.on('precompose', function(evt) {
